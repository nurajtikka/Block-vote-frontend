  ...
  >
    ...
    >
      <div>
        ...
        >
          {language === 'en' && 'Please confirm that you have chosen' || language === 'si' && 'කරුණාකර ඔබ තෝරාගත් බව තහවුරු කරන්න' || language === 'ta' && 'நீங்கள் தேர்ந்தெடுத்துள்ளீர்கள் என்பதை உறுதிப்படுத்தவும்'}
        </p>
      </div>
    </div>
    ...
    <div style={{ textAlign: "center", marginTop: "5%" }}>
      <Space wrap>
        <Button className="ant-btn-outline-white" size="large" onClick={()=> router.push('/pages/thankyou')}>
          {language === 'en' && 'Confirm' || language === 'si' && 'තහවුරු කරන්න' || language === 'ta' && 'உறுதிப்படுத்தவும்'}
        </Button>
        <Button type="default" size="large" className="ant-btn-outline-white" onClick={()=> router.push('/pages/select')}>
          {language === 'en' && 'Back' || language === 'si' && 'ආපසු' || language === 'ta' && 'பின்செல்'}
        </Button>
      </Space>
    </div>
  </main>
